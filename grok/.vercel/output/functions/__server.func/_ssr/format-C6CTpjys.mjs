//#region node_modules/.nitro/vite/services/ssr/assets/format-C6CTpjys.js
/** Fixed demo clock: 9 September 2026, 18:00 Europe/London. */
var DEMO_CLOCK = "2026-09-09T18:00:00+01:00";
var MEETING_ISO = "2026-09-10T14:00:00+01:00";
var TRAVEL_DATE = "2026-09-10";
var CANONICAL_REQUEST = "My flight has been cancelled. Get me from Heathrow to my Lisbon meeting by 2pm tomorrow, with one hotel night nearby. Keep the outbound flight, checked bag, hotel and airport transfer under £650.";
var TRAVELLER = {
...
var ENTITIES = [
	...
	},
	{
		...
		attrs: {
			address: "Rua da Misericórdia, Chiado",
			tz: "Europe/Lisbon"
		}
	},
	{
...
var HOTELS = [
	{
		...
		lexical: .62,
		semantic: .84,
		description: "A small courtyard house in Príncipe Real. Limewashed rooms, an orange tree, and a desk that faces the garden. Quiet after ten. Fourteen minutes on foot to Ribeira Design Studio."
	},
	{
		...
		lexical: .71,
		semantic: .77,
		description: "A Chiado townhouse with terrazzo floors and a lively ground-floor lounge used by visiting studios. Eight minutes to the venue. More energy than hush — the bar stays open late."
	},
	{
		...
		lexical: .44,
		semantic: .69,
		description: "A hillside terrace looking over tiled roofs to the river. Quiet and photogenic, but twenty-six minutes on foot to the studio — outside the nearby walking rule."
	}
];
var TRANSFER = {
...
function clockLabel(iso = DEMO_CLOCK) {
...
function elapsedMinutes(fromIso, toIso) {
	return Math.round((Date.parse(toIso) - Date.parse(fromIso)) / 6e4);
}
...
//#endregion
export { clockLabel as _, IMAGE_DISCLOSURES as a, rid as b, MEETING_ISO as c, ORIGINAL_BOOKING as d, POLICIES as f, addMinutes as g, TRAVEL_DATE as h, HOTELS as i, OFFERS as l, TRAVELLER as m, DEMO_CLOCK as n, LAYER_META as o, TRANSFER as p, ENTITIES as r, LEGS as s, CANONICAL_REQUEST as t, ONBOARDING as u, elapsedMinutes as v, timeInZone as x, gbp as y };
