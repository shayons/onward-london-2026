...
async function submit(text,options={}){
  ...
  const user={role:'user',text},answer={role:'assistant',text:'',pending:true,turn:state.turn,bookingTurn:Boolean(options.confirmBooking)};state.messages.push(user,answer);state.chatAnchor='.user-message:nth-last-child(2)';renderTrip();
